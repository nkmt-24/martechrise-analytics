...
const SLUG = 'analytics-implementation'
...
export default function AnalyticsImplementationPage() {
  return (
    <main itemScope itemType="https://schema.org/Service">
      ...
      <ServiceRelatedCaseStudies
        serviceSlug={SLUG}
        serviceTitle="Analytics Implementation"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            serviceType: 'GA4, Adobe Analytics & Tealium Implementation',
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Deliverables',
