...
const SLUG = 'tracking-architecture'
...
export default function TrackingArchitecturePage() {
  return (
    <main itemScope itemType="https://schema.org/Service">
      ...
      <ServiceRelatedCaseStudies
        serviceSlug={SLUG}
        serviceTitle="Tracking Architecture"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            serviceType: 'Analytics Tracking Architecture & Solution Design',
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Deliverables',
